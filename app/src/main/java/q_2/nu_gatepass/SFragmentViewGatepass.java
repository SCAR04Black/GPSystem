...
public class SFragmentViewGatepass extends Fragment {
    private OnSViewGatepassFragmentInteractionListener mListener;
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnSViewGatepassFragmentInteractionListener) {
            mListener = (OnSViewGatepassFragmentInteractionListener) context;
        } else {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (view.findViewById(R.id.list) instanceof RecyclerView) {
            ...
            recyclerView.setAdapter(new SFragmentViewGatepassAdapter(mItems, mListener));
        }
        return view;
    }


    public interface OnSViewGatepassFragmentInteractionListener {
        void onSViewGatepassFragmentInteraction(Context mContext, GatepassListViewItem item);
    }
